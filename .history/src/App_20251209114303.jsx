          ...
          <div className="p-8 flex flex-col h-full justify-center bg-indigo-50">
            ...
            <div className="space-y-4">
              <button
                ...
                className="w-full bg-indigo-600 text-white py-4 rounded-xl font-bold shadow-lg active:scale-95 transition-all flex items-center justify-center gap-2"
              >
                <User size={20} /> {t.login_user}
              </button>
              <button
                onClick={() => handleLogin("admin")}
                className="w-full bg-white text-indigo-600 border-2 border-indigo-100 py-4 rounded-xl font-bold shadow-sm active:scale-95 transition-all flex items-center justify-center gap-2"
              >
            ...
            <div className="bg-indigo-900 text-white pt-6 p-6 pb-10 rounded-b-[2.5rem] shadow-xl relative z-10">
              ...
              <div className="text-center">
                ...
                <div className="flex items-center justify-center gap-2">
                  {kycStatus === "none" && (
                    <span className="text-2xl font-bold text-gray-400">{t.not_verified}</span>
                  )}
                  {kycStatus === "submitted" && (
                    <span className="text-2xl font-bold text-yellow-400">{t.kyc_pending}</span>
                  )}
                  {kycStatus === "approved" && (
                    <span className="text-2xl font-bold text-green-400">{t.approved}</span>
                  )}
                  {kycStatus === "rejected" && (
                    <span className="text-2xl font-bold text-red-400">{t.rejected}</span>
                  )}
                </div>
              </div>
            </div>
        ...
        {currentScreen === "kyc_flow" && (
          <div className="flex flex-col h-full bg-gray-50">
            ...
            <div className="flex-1 p-6 overflow-y-auto">
              ...
              {/* STEP 2: DOCUMENT UPLOAD (ONLY HERE) */}
              {kycStep === 2 && (
                <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4">
                  <h2 className="text-xl font-bold text-gray-800 mb-4">{t.step_2}</h2>
                  ...
                  <input
                    ...
                    multiple
                    onChange={(e) =>
                      handleFileUpload("docFront", Array.from(e.target.files))
                    }
                  />
                  ...
                  <input
                    ...
                    multiple
                    onChange={(e) =>
                      handleFileUpload("docBack", Array.from(e.target.files))
                    }
                  />
    ...
    {!formData.selfie ? (
      ...
      <CameraView
        ...
        onCapture={(base64Image) => {
          // Save base64 selfie
          setFormData({ ...formData, selfie: base64Image });
        }}
      />
      ...
      <div className="aspect-[3/4] bg-gray-800 rounded-2xl flex items-center justify-center relative overflow-hidden">
        ...
        <button
          ...
          className="absolute bottom-4 text-white text-sm underline"
        >
          {t.retake}
        </button>
      </div>
...
<div className="p-4 grid grid-cols-2 gap-2">
  ...
  {/* SELFIE */}
  <div className="bg-gray-100 rounded-lg h-24 flex items-center justify-center text-xs text-gray-400 col-span-2 overflow-hidden">
    {formData.selfie ? (
      <img
        src={formData.selfie}
        alt="Selfie"
