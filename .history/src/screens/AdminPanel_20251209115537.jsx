        ...
        {status === 'submitted' ? (
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div className="p-4 grid grid-cols-2 gap-3">
              ...
              {/* ID FRONT */}
              <div className="bg-gray-100 rounded-lg min-h-32 flex items-center justify-center overflow-hidden p-2">
              ...
              {/* SELFIE (FULL VIEW) */}
              <div className="bg-gray-100 rounded-lg col-span-2 flex items-center justify-center overflow-hidden p-2">
                {renderSelfie()}
              </div>
