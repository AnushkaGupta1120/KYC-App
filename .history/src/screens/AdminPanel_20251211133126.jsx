...
export default function AdminPanel({
  ...
  return (
    <div className="p-6">
      <button onClick={() => setCurrentScreen("login")} className="flex items-center text-sm text-indigo-600 mb-4">
      ...
      <div className="bg-white p-4 rounded-xl shadow border border-gray-200">
        ...
        <button
          onClick={() => {
            if (reason.trim().length === 0) return alert("Please enter a reason");
