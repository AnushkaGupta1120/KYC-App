...
const Dashboard = ({ t, user, status, setScreen, setStatus, resetKyc, toggleVoice }) => {
  return (
    <div className="flex flex-col h-full relative">
      ...
      <button
        onClick={toggleVoice}
        className="absolute top-4 right-6 bg-white text-indigo-900 p-2 rounded-full shadow-xl z-[9999]"
      >
        🔊
      </button>

      {/* Header */}
      <div className="bg-indigo-900 text-white pt-10 p-6 pb-12 rounded-b-[2.5rem] shadow-xl relative z-10">
