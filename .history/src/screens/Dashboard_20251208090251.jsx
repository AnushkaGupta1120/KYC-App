...
{/* Header */}
<div className="bg-indigo-900 text-white pt-6 p-6 pb-10 rounded-b-[2.5rem] shadow-xl relative">

  {/* Voice Button – now positioned relative to THIS header */}
  <button
    onClick={toggleVoice}
    className="absolute top-4 right-4 bg-white text-indigo-900 p-3 rounded-full shadow-xl z-50"
  >
    🔊
  </button>
